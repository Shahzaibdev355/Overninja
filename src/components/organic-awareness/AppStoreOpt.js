                            ...
                            <article className="post-6 page type-page status-publish ast-article-single" id="post-6">
                                ...
                                <div className="entry-content clear" itemProp="text">
                                    <div data-overninja-type="wp-page" data-overninja-id={6} className="overninja overninja-6">
                                        <section style={{paddingBottom: "0px"}} className="overninja-section overninja-top-section overninja-element overninja-element-7b51e64 overninja-section-boxed overninja-section-height-default overninja-section-height-default" data-id="7b51e64" data-element_type="section">
                                            <div className="overninja-background-overlay" />
                                            <div className="overninja-container overninja-column-gap-no">
                                                <div className="overninja-column overninja-col-50 overninja-top-column overninja-element overninja-element-d91309a" data-id="d91309a" data-element_type="column">
                                                    <div style={{ alignSelf: 'end' }} className="overninja-widget-wrap overninja-element-populated">
                                                ...
                                                <div className="overninja-column overninja-col-50 overninja-top-column overninja-element overninja-element-ec80e8e brand-marketing-heading" data-id="ec80e8e" data-element_type="column">
                                                    <div className="overninja-widget-wrap creative-content-heading">
                                        ...
                                        <section style={{ marginTop: 70 }} className="overninja-section overninja-top-section overninja-element overninja-element-837ff72 overninja-section-boxed overninja-section-height-default overninja-section-height-default" data-id="837ff72" data-element_type="section">
                                            <div className="overninja-container overninja-column-gap-no">
                                                <div className="overninja-column overninja-col-100 overninja-top-column overninja-element overninja-element-96e569c" data-id="96e569c" data-element_type="column">
                                                    <div className="overninja-widget-wrap overninja-element-populated">
                                                        <section className="overninja-section overninja-inner-section overninja-element overninja-element-3686581 overninja-section-boxed overninja-section-height-default overninja-section-height-default" data-id={3686581} data-element_type="section">
                                                            <div className="overninja-container overninja-column-gap-no">
                                                                <div className="overninja-column overninja-col-100 overninja-inner-column overninja-element overninja-element-" data-id="6fb823c" data-element_type="column">
                                                                    <div className="overninja-widget-wrap overninja-element-populated">
                                                                        <div className="overninja-element overninja-element-f89cf62 overninja-widget overninja-widget-text-editor" data-id="f89cf62" data-element_type="widget" data-widget_type="text-editor.default">
                                                                            <div className="overninja-widget-container">
                                                                                <h4 className="overninja-heading-title overninja-size-default">
                                                                                    Increase your app downloads and enhance
                                                                                    your rankings.</h4>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div className="overninja-column overninja-col-100 overninja-inner-column overninja-element overninja-element-" data-id="6fb823c" data-element_type="column">
                                                                    <div className="overninja-widget-wrap overninja-element-populated">
                                                                        <div className="overninja-element overninja-element-f89cf62 overninja-widget overninja-widget-text-editor" data-id="f89cf62" data-element_type="widget" data-widget_type="text-editor.default">
                                                                            <div className="overninja-widget-container">
                                                                                <h4 className="overninja-heading-title overninja-size-default">
                                                                                    Increasing Downloads</h4>
                                                                            </div>
                                                                            <div className="overninja-widget-container">
                                                                                <p>Are you aware that the App Store and
                                                                                    Google Play collectively host over 5.6
                                                                                    million apps? Apps that don't rank well
                                                                                    in search results face fierce
                                                                                    competition, underscoring the importance
                                                                                    of app store optimization (ASO) services
                                                                                    for mobile success.
                                                                                    Investing in ASO represents the most
                                                                                    cost-effective strategy in mobile
                                                                                    marketing. When executed correctly, it
                                                                                    can drive downloads at a minimal cost,
                                                                                    even at scale and across multiple
                                                                                    markets.
                                                                                </p>
                                                                                <p>Leveraging our technology, proprietary
                                                                                    methodologies, and a team of global ASO
                                                                                    experts, Overninja ensures your app gets
                                                                                    maximum visibility. We can optimize your
                                                                                    ASO efforts to propel your app to the
                                                                                    top of search rankings, increase
                                                                                    downloads, and facilitate sustained and
                                                                                    robust growth.
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div className="overninja-element overninja-element-addb53c overninja-widget overninja-widget-heading" data-id="addb53c" data-element_type="widget" data-widget_type="heading.default">
                                                            <div className="overninja-widget-container">
                                                                <h3 className="overninja-heading-title overninja-size-default">
                                                                    An agency that stands out from the rest </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div className="overninja-widget-wrap overninja-element-populated">
                                                        <section className="overninja-section overninja-inner-section overninja-element overninja-element-5eeef6a overninja-section-boxed overninja-section-height-default overninja-section-height-default" data-id="5eeef6a" data-element_type="section">
                                                            <div className="overninja-container overninja-column-gap-no">
                                                                <div className="overninja-column overninja-col-66 overninja-inner-column overninja-element overninja-element-7c9fcde" data-id="7c9fcde" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                                                    <div className="overninja-widget-wrap overninja-element-populated">
                                                                        ...
                                                                        <div className="overninja-element overninja-element-82aedfd overninja-widget overninja-widget-text-editor" data-id="82aedfd" data-element_type="widget" data-widget_type="text-editor.default">
                                                                            <div className="overninja-widget-container">
                                                                                <p>We generate an extensive pool of keywords
                                                                                    for research, surpassing 5,000 keywords
                                                                                    per language per store. This is 20 times
                                                                                    deeper than what any other agency
                                                                                    offers, providing invaluable support in
                                                                                    crafting the most effective ASO
                                                                                    strategy. Need more installs? No
                                                                                    worries.
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div className="overninja-column overninja-col-33 overninja-inner-column overninja-element overninja-element-df403d7" data-id="df403d7" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                                                    <div className="overninja-widget-wrap overninja-element-populated app-store-op-bg1">
                                                        ...
                                                        <section className="overninja-section overninja-inner-section overninja-element overninja-element-e987fef overninja-reverse-mobile overninja-section-boxed overninja-section-height-default overninja-section-height-default" data-id="e987fef" data-element_type="section">
                                                            <div className="overninja-container overninja-column-gap-no">
                                                                <div className="overninja-column overninja-col-33 overninja-inner-column overninja-element overninja-element-e2bbada" data-id="e2bbada" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                                                    <div className="overninja-widget-wrap overninja-element-populated app-store-op-bg2">
                                                                ...
                                                                <div className="overninja-column overninja-col-66 overninja-inner-column overninja-element overninja-element-450fe49" data-id="450fe49" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                                                    <div className="overninja-widget-wrap overninja-element-populated">
                                                                        ...
                                                                        <div className="overninja-element overninja-element-9cd7621 overninja-widget overninja-widget-text-editor" data-id="9cd7621" data-element_type="widget" data-widget_type="text-editor.default">
                                                                            <div className="overninja-widget-container">
                                                                                <p>We attribute part of our success to
                                                                                    collaborating closely with our clients.
                                                                                    Through our ASO strategy, we maintain an
                                                                                    ongoing dialogue with our clients, who
                                                                                    possess an unparalleled understanding of
                                                                                    their brand, while we contribute the
                                                        ...
                                                        <section className="overninja-section overninja-inner-section overninja-element overninja-element-5eeef6a overninja-section-boxed overninja-section-height-default overninja-section-height-default" data-id="5eeef6a" data-element_type="section">
                                                            <div className="overninja-container overninja-column-gap-no">
                                                                        ...
                                                                        <div className="overninja-element overninja-element-82aedfd overninja-widget overninja-widget-text-editor" data-id="82aedfd" data-element_type="widget" data-widget_type="text-editor.default">
                                                                            <div className="overninja-widget-container">
                                                                                <p>
                                                                                    ...
                                                                                    collaborating with over 600 apps, we
                                                                                    have a deep understanding of what yields
                                                                                    results. Our expertise spans nearly
                                                                                    every industry represented in app
                                                                                    stores. We've partnered with some of the
                                                                                    largest global enterprises, consistently
                                                                ...
                                                                <div className="overninja-column overninja-col-33 overninja-inner-column overninja-element overninja-element-df403d7" data-id="df403d7" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                                                    <div className="overninja-widget-wrap overninja-element-populated app-store-op-bg3">
                                                                        <div className="overninja-element overninja-element-18c89c1 overninja-widget overninja-widget-spacer" data-id="18c89c1" data-element_type="widget" data-widget_type="spacer.default">
                                                                            <div className="overninja-widget-container">
                                                                                <div className="overninja-spacer">
                                                                                    <div className="overninja-spacer-inner">
                                            ...
                                            <div className="overninja-container overninja-column-gap-no">
                                                ...
                                                <div className="overninja-column overninja-col-50 overninja-top-column overninja-element overninja-element-30c8b0e" data-id="30c8b0e" data-element_type="column">
                                                    <div className="overninja-widget-wrap overninja-element-populated">
                                                        <section className="overninja-section overninja-inner-section overninja-element overninja-element-5eeef6a overninja-section-boxed overninja-section-height-default overninja-section-height-default" data-id="5eeef6a" data-element_type="section">
                                                            <div className="overninja-container overninja-column-gap-no">
                                                                <div className="overninja-column overninja-col-100 overninja-inner-column overninja-element overninja-element-7c9fcde" data-id="7c9fcde" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                                                    <div className="overninja-widget-wrap overninja-element-populated">
                                                                        <div className="overninja-container overninja-column-gap-no">
                                                                            <div className="overninja-column overninja-col-30 overninja-inner-column overninja-element overninja-element-a19f51" data-id="a19f518" data-element_type="column">
                                                                                <div className="overninja-widget-wrap overninja-element-populated">
                                                                                    <div className="overninja-element overninja-element-fe7f46d overninja-widget overninja-widget-heading" data-id="fe7f46d" data-element_type="widget" data-widget_type="heading.default" style={{ marginBottom: 20 }}>
                                                                                        <div className="overninja-widget-container">
                                                                                            <h5 className="overninja-heading-title overninja-size-default">
                                                                                                Continuously ahead of the curve </h5>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div className="overninja-column overninja-col-70 overninja-inner-column overninja-element overninja-element-6fb823" data-id="6fb823c" data-element_type="column">
                                                                                <div className="overninja-widget-wrap overninja-element-populated">
                                                                                    <div className="overninja-element overninja-element-f89cf62 overninja-widget overninja-widget-text-editor" data-id="f89cf62" data-element_type="widget" data-widget_type="text-editor.default">
                                                                                        <div className="overninja-widget-container">
                                                                                            <p>
                                                                                                App store algorithms and optimal strategies are continually evolving. Our ASO experts diligently track industry trends and adapt our internal procedures to maintain our leadership in producing exceptional ASO results.
                                                                                            </p>
                                                                                            <p>
                                                                                                From crafting descriptions, titles, and keyword lists rooted in extensive keyword research to designing, conducting A/B testing, measuring performance, and achieving desired outcomes in over 25 languages, Overninja stands out as the unparalleled ASO authority.
                                                                                            </p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div className="overninja-column overninja-col-30 overninja-inner-column overninja-element overninja-element-a19f51" data-id="a19f518" data-element_type="column">
                                                                                <div className="overninja-widget-wrap overninja-element-populated">
                                                                                    <div className="overninja-element overninja-element-fe7f46d overninja-widget overninja-widget-heading" data-id="fe7f46d" data-element_type="widget" data-widget_type="heading.default" style={{ marginBottom: 20 }}>
                                                                                        <div className="overninja-widget-container">
                                                                                            <h5 className="overninja-heading-title overninja-size-default">
                                                                                                Optimize each and every opportunity </h5>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div className="overninja-column overninja-col-70 overninja-inner-column overninja-element overninja-element-6fb823" data-id="6fb823c" data-element_type="column">
                                                                                <div className="overninja-widget-wrap overninja-element-populated">
                                                                                    <div className="overninja-element overninja-element-f89cf62 overninja-widget overninja-widget-text-editor" data-id="f89cf62" data-element_type="widget" data-widget_type="text-editor.default">
                                                                                        <div className="overninja-widget-container">
                                                                                            <p>
                                                                                            Once we've conducted a thorough audit of your app storefront, we identify prime opportunities for localization and other straightforward improvements to unlock your app's full potential.
                                                                                            </p>
                                                                                            <p>
                                                                                                Many languages have a presence in multiple countries, and by optimizing your keywords effectively, we can boost your rankings across various markets simultaneously.
                                                                                            </p>
                                                                                            <p>
                                                                                                Furthermore, we excel in App Store Optimization (ASO) for in-app events. ASO isn't solely about increasing installations but also about driving specific actions within the app, such as subscriptions.
                                                                                            </p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div className="overninja-container overninja-column-gap-no">
                                                                            <div className="overninja-column overninja-col-30 overninja-inner-column overninja-element overninja-element-a19f51" data-id="a19f518" data-element_type="column">
                                                                                <div className="overninja-widget-wrap overninja-element-populated">
                                                                                    <div className="overninja-element overninja-element-fe7f46d overninja-widget overninja-widget-heading" data-id="fe7f46d" data-element_type="widget" data-widget_type="heading.default" style={{ marginBottom: 20 }}>
                                                                                        <div className="overninja-widget-container">
                                                                                            <h5 className="overninja-heading-title overninja-size-default">
                                                                                                Harness the most recent iOS capabilities </h5>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div className="overninja-column overninja-col-70 overninja-inner-column overninja-element overninja-element-6fb823" data-id="6fb823c" data-element_type="column">
                                                                                <div className="overninja-widget-wrap overninja-element-populated">
                                                                                    <div className="overninja-element overninja-element-f89cf62 overninja-widget overninja-widget-text-editor" data-id="f89cf62" data-element_type="widget" data-widget_type="text-editor.default">
                                                                                        <div className="overninja-widget-container">
                                                                                            <p>iOS 15 introduced a range of new features that can enhance your ASO (App Store Optimization) efforts significantly.
                                                                                                Make sure you take advantage of these opportunities to boost your app's organic downloads.
                                                                                            </p>
                                                                                            <p>
                                                                                                You can now experiment
                                                                                                with up to four sets of App Store page variations, create 35 product pages for paid traffic, and make substantial
                                                                                                improvements in your conversion rates.</p>
                                                                                                <p>
                                                                                                Additionally, you have the ability to optimize for keyword rankings, icons, screenshot galleries, and preview videos with more creative and testing flexibility than ever before.
                                                                                                </p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                    ...
                                                    <div className="overninja-widget-wrap overninja-element-populated">
                                                        <section className="overninja-section overninja-inner-section overninja-element overninja-element-5eeef6a overninja-section-boxed overninja-section-height-default overninja-section-height-default" data-id="5eeef6a" data-element_type="section">
                                                            <div className="overninja-container overninja-column-gap-no">
                                                                <div className="overninja-column overninja-col-66 overninja-inner-column overninja-element overninja-element-7c9fcde" data-id="7c9fcde" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                                                    <div className="overninja-widget-wrap overninja-element-populated">
                                                                        ...
                                                                        <div className="overninja-element overninja-element-82aedfd overninja-widget overninja-widget-text-editor" data-id="82aedfd" data-element_type="widget" data-widget_type="text-editor.default">
                                                                            <div className="overninja-widget-container">
                                                                                <p>
                                                                                    To begin, we aim to comprehend our clients' Key Performance Indicators (KPIs): their objectives, their willingness to adhere to brand guidelines, their preferences for experimentation, and various other data points that aid us in formulating the perfect ASO strategy.
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div className="overninja-column overninja-col-33 overninja-inner-column overninja-element overninja-element-df403d7" data-id="df403d7" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                                                    <div className="overninja-widget-wrap overninja-element-populated app-store-op-bg4">
                                                                        <div className="overninja-element overninja-element-18c89c1 overninja-widget overninja-widget-spacer" data-id="18c89c1" data-element_type="widget" data-widget_type="spacer.default">
                                                                            <div className="overninja-widget-container">
                                                                                <div className="overninja-spacer">
                                                                                    <div className="overninja-spacer-inner">
                                                        ...
                                                        <section className="overninja-section overninja-inner-section overninja-element overninja-element-e987fef overninja-reverse-mobile overninja-section-boxed overninja-section-height-default overninja-section-height-default" data-id="e987fef" data-element_type="section">
                                                            <div className="overninja-container overninja-column-gap-no">
                                                                <div className="overninja-column overninja-col-33 overninja-inner-column overninja-element overninja-element-e2bbada" data-id="e2bbada" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                                                    <div className="overninja-widget-wrap overninja-element-populated app-store-op-bg5">
                                                                        <div className="overninja-element overninja-element-56ac733 overninja-widget overninja-widget-spacer" data-id="56ac733" data-element_type="widget" data-widget_type="spacer.default">
                                                                            <div className="overninja-widget-container">
                                                                                <div className="overninja-spacer">
                                                                                    <div className="overninja-spacer-inner">
                                                                ...
                                                                <div className="overninja-column overninja-col-66 overninja-inner-column overninja-element overninja-element-450fe49" data-id="450fe49" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                                                    <div className="overninja-widget-wrap overninja-element-populated">
                                                                        <div className="overninja-element overninja-element-a8cfefa overninja-widget overninja-widget-heading" data-id="a8cfefa" data-element_type="widget" data-widget_type="heading.default">
                                                                            <div className="overninja-widget-container">
                                                                                <h5 className="overninja-heading-title overninja-size-default">
                                                                                    Keyword and Competitor Research </h5>
                                                                            </div>
                                                                        </div>
                                                                        <div className="overninja-element overninja-element-9cd7621 overninja-widget overninja-widget-text-editor" data-id="9cd7621" data-element_type="widget" data-widget_type="text-editor.default">
                                                                            <div className="overninja-widget-container">
                                                                                <p>
                                                                                    We meticulously examine and track more than 5,000 keywords. This involves providing an initial report with our recommendations for all content sections, along with detailed insights and suggestions tailored to each app store.
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <section className="overninja-section overninja-inner-section overninja-element overninja-element-5eeef6a overninja-section-boxed overninja-section-height-default overninja-section-height-default" data-id="5eeef6a" data-element_type="section">
                                                            <div className="overninja-container overninja-column-gap-no">
                                                                <div className="overninja-column overninja-col-66 overninja-inner-column overninja-element overninja-element-7c9fcde" data-id="7c9fcde" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                                                    <div className="overninja-widget-wrap overninja-element-populated">
                                                                        ...
                                                                        <div className="overninja-element overninja-element-82aedfd overninja-widget overninja-widget-text-editor" data-id="82aedfd" data-element_type="widget" data-widget_type="text-editor.default">
                                                                            <div className="overninja-widget-container">
                                                                                <p>
                                                                                    We consistently monitor app rankings and downloads on both iOS and the Google Play Store. What sets Overninja apart is our in-depth mobile expertise, enabling us to not only track trends but also understand the underlying reasons behind them. This insight empowers us to optimize your App Store Optimization (ASO) strategy and generate a substantial increase in organic installations.
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div className="overninja-column overninja-col-33 overninja-inner-column overninja-element overninja-element-df403d7" data-id="df403d7" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                                                    <div className="overninja-widget-wrap overninja-element-populated app-store-op-bg6">
                                                                        <div className="overninja-element overninja-element-18c89c1 overninja-widget overninja-widget-spacer" data-id="18c89c1" data-element_type="widget" data-widget_type="spacer.default">
                                                                            <div className="overninja-widget-container">
                                                                                <div className="overninja-spacer">
                                                                                    <div className="overninja-spacer-inner">
                                                                        ...
                                                                        <div className="overninja-container overninja-column-gap-no">
                                                                            ...
                                                                            <div className="overninja-column overninja-col-70 overninja-inner-column overninja-element overninja-element-6fb823" data-id="6fb823c" data-element_type="column">
                                                                                <div className="overninja-widget-wrap overninja-element-populated">
                                                                                    <div className="overninja-element overninja-element-f89cf62 overninja-widget overninja-widget-text-editor" data-id="f89cf62" data-element_type="widget" data-widget_type="text-editor.default">
                                                                                        <div className="overninja-widget-container">
                                                                                            <p>Gathering data from top ASO tools and crafting optimization recommendations based on shared insights. Continuously tracking Google Play and Apple App Store algorithms to stay updated on evolving trends.
                                                                                            </p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div className="overninja-container overninja-column-gap-no">
                                                                            ...
                                                                            <div className="overninja-column overninja-col-70 overninja-inner-column overninja-element overninja-element-6fb823" data-id="6fb823c" data-element_type="column">
                                                                                <div className="overninja-widget-wrap overninja-element-populated">
                                                                                    <div className="overninja-element overninja-element-f89cf62 overninja-widget overninja-widget-text-editor" data-id="f89cf62" data-element_type="widget" data-widget_type="text-editor.default">
                                                                                        <div className="overninja-widget-container">
                                                                                            <p>We track millions of keywords and phrases to provide real-time data on trending search terms. Additionally, we automatically assess your likelihood of getting indexed for these suggested terms.
                                                                                            </p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div className="overninja-container overninja-column-gap-no">
                                                                            ...
                                                                            <div className="overninja-column overninja-col-70 overninja-inner-column overninja-element overninja-element-6fb823" data-id="6fb823c" data-element_type="column">
                                                                                <div className="overninja-widget-wrap overninja-element-populated">
                                                                                    <div className="overninja-element overninja-element-f89cf62 overninja-widget overninja-widget-text-editor" data-id="f89cf62" data-element_type="widget" data-widget_type="text-editor.default">
                                                                                        <div className="overninja-widget-container">
                                                                                            <p>You've put in significant effort to attract your ideal users, even using paid advertisements. However, if your
                                                                                                conversion rates are lackluster, all your hard work goes to waste. On the flip side, a high conversion rate can
                                                                                                significantly boost your key metrics, effectively multiplying your gains.
                                                                                            </p>
                                                                                            <p>
                                                                                                Are you ready to reduce your acquisition costs and see a substantial increase in ROI? Conversion Rate Optimization
                                                                                                (CRO) is the answer, and we've devised a proven blueprint for CRO success.
                                                                                            </p>
                                                                                            <p>
                                                                                                Mobile CRO involves systematically
                                                                                                testing various elements like screenshot styles, icons, videos, creative assets, text, colors, and more to
                                                                                                scientifically identify the most effective combinations for driving conversions. We continually iterate and optimize
                                                ...
                                                <div className="overninja-column overninja-col-50 overninja-top-column overninja-element overninja-element-694fdb8" data-id="694fdb8" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;gradient&quot;}">
                                                    <div className="overninja-widget-wrap overninja-element-populated">
                                                        ...
                                                        <div className="overninja-element overninja-element-16a11df overninja-widget overninja-widget-text-editor" data-id="16a11df" data-element_type="widget" data-widget_type="text-editor.default">
                                                            <div className="overninja-widget-container">
                                                                <p>Significantly enhance the visibility of your website.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="overninja-column overninja-col-50 overninja-top-column overninja-element overninja-element-9bc185c" data-id="9bc185c" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;gradient&quot;}">
                                                    <div className="overninja-widget-wrap overninja-element-populated mob-box-color">
                                                        ...
                                                        <div className="overninja-element overninja-element-db6615f overninja-widget overninja-widget-text-editor" data-id="db6615f" data-element_type="widget" data-widget_type="text-editor.default">
                                                            <div className="overninja-widget-container">
                                                                <p>Establish enduring brand recognition by enhancing your visibility.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="overninja-column overninja-col-50 overninja-top-column overninja-element overninja-element-944be9d" data-id="944be9d" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;gradient&quot;}">
                                                    <div className="overninja-widget-wrap overninja-element-populated">
                                                        ...
                                                        <div className="overninja-element overninja-element-f2e2008 overninja-widget overninja-widget-text-editor" data-id="f2e2008" data-element_type="widget" data-widget_type="text-editor.default">
                                                            <div className="overninja-widget-container">
                                                                <p>Dramatically increase your organic page views.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="overninja-container overninja-column-gap-no">
                                                ...
                                                <div className="overninja-column overninja-col-50 overninja-top-column overninja-element overninja-element-694fdb8" data-id="694fdb8" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;gradient&quot;}">
                                                    <div className="overninja-widget-wrap overninja-element-populated  mob-box-color">
                                                        ...
                                                        <div className="overninja-element overninja-element-16a11df overninja-widget overninja-widget-text-editor" data-id="16a11df" data-element_type="widget" data-widget_type="text-editor.default">
                                                            <div className="overninja-widget-container">
                                                                <p>Climb to the summit of search results using the correct keywords.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="overninja-column overninja-col-50 overninja-top-column overninja-element overninja-element-9bc185c" data-id="9bc185c" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;gradient&quot;}">
                                                    <div className="overninja-widget-wrap overninja-element-populated">
                                                        ...
                                                        <div className="overninja-element overninja-element-db6615f overninja-widget overninja-widget-text-editor" data-id="db6615f" data-element_type="widget" data-widget_type="text-editor.default">
                                                            <div className="overninja-widget-container">
                                                                <p>Boost app page conversion rates significantly.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="overninja-column overninja-col-50 overninja-top-column overninja-element overninja-element-944be9d" data-id="944be9d" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;gradient&quot;}">
                                                    <div className="overninja-widget-wrap overninja-element-populated  mob-box-color">
                                                        ...
                                                        <div className="overninja-element overninja-element-f2e2008 overninja-widget overninja-widget-text-editor" data-id="f2e2008" data-element_type="widget" data-widget_type="text-editor.default">
                                                            <div className="overninja-widget-container">
                                                                <p>Boost user acquisition outcomes.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
